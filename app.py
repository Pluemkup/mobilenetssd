...
lineaccesstoken = 'iRp0iJ/Z6dyDw0rsHWnmvufnZyq4kbrMTDGk0/dM0fnQdt70Z3OCM30P80BubQb7i8kLbH5HBt/zu44ew5PzOTLwdStCoSr4R0pfdvkwZRlqpeG3BeyO5hoZUXfPAGawe3u/iW1IS1AwIIety/nk1wdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "กินข้าวกันมั้ย") :
            replyObj = TextSendMessage(text="ขอบคุณ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "เที่ยวไหนดี") :
            replyObj = TextSendMessage(text="บ้านเลยพี่")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/c1cd657d-cd60-4942-ab7d-401b469cc386"
